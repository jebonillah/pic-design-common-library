...
# Observación de los modos TM solicitados
print("Graficando campo Ey (TM2) en guía rectangular...")
rect_wg.plot_field(field_name="Ey", mode_index=5)
plt.show()

print("Graficando campo Ey (TM2) en guía trapezoidal...")
trap_wg.plot_field(field_name="Ey", mode_index=5)
plt.show()
